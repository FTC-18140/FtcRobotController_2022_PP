...
@Autonomous(name = "AutoMythic", group = "FTCLib")
@Config
public class AutoMythic extends TBDOpModeBase
{
    ...
    private SequentialCommandGroup driveToJunction()
    {
        ...
        ArriveCommand otherHalfFirst = new ArriveCommand(153, 90, 0.3, 0.5, 40, 2, chassis, odometry);
        TurnCommand overshotTurn = new TurnCommand(50, 0.3, 0.1, 10, 2, chassis, odometry);
        ...
        LiftDistanceCommand goUpToHigh = new LiftDistanceCommand(48, 0.75, lift);
        ...
        SequentialCommandGroup firstJunction = new SequentialCommandGroup(liftArmAndDrive, liftSlideAndDrive, overshotTurn, getCloserFirst);
    ...
    {
        DepartCommand backUpBeforeTurning1 = new DepartCommand(155, 95, -0.2, 0.4, 10, 2, true, chassis, odometry);
        TurnCommand turnToConeStack = new TurnCommand(-90, 0.3, 0.1, 10, 2, chassis, odometry);
        DepartCommand goToConeStack = new DepartCommand ( 149, 15, 0.4, 0.1, 10, 2, true, chassis, odometry);


        return new SequentialCommandGroup(backUpBeforeTurning1, turnToConeStack, goToConeStack);
    }
